...
input double malow = 6;
input double mahigh = 150;
...
void OnTick()
  {
//---
   ma_low = iMA(NULL, PERIOD_M1, malow,0,MODE_SMA,PRICE_CLOSE,0);
   ma_high = iMA(NULL, PERIOD_M1, mahigh,0,MODE_SMA,PRICE_CLOSE,0);
